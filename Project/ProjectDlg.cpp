...
BEGIN_MESSAGE_MAP(CProjectDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON_Schema, &CProjectDlg::OnBnClickedButtonSchema)
	ON_BN_CLICKED(IDC_BUTTON_Select, &CProjectDlg::OnBnClickedButtonSelect)
	ON_BN_CLICKED(IDC_BUTTON_Insert2, &CProjectDlg::OnBnClickedButtonInsert2)
	ON_BN_CLICKED(IDC_BUTTON_Delete2, &CProjectDlg::OnBnClickedButtonDelete2)
	ON_BN_CLICKED(IDC_BUTTON_Update, &CProjectDlg::OnBnClickedButtonUpdate)
END_MESSAGE_MAP()
...
BOOL CProjectDlg::OnInitDialog()
{
	...
	if (db_connect()) {
		MessageBox("Connecting to DB success!");
	}
	else {
...
void CProjectDlg::OnBnClickedButtonSchema()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	SchemaCheckDia schema;
	schema.parent = this;
	schema.DoModal();
}
...
void CProjectDlg::OnBnClickedButtonInsert2()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	InsertionDlg insert(this);
	insert.DoModal();
}


void CProjectDlg::OnBnClickedButtonDelete2()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	DeleteDlg del;
	del.parent = this;
...
void CProjectDlg::OnBnClickedButtonUpdate()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	UpdateSales sales(this);
	sales.DoModal();
}
